        ...
        <>
            <div className=" w-[970px] mt-[30px] pl-[30px]">
                <div className="flex justify-between ">
                    ...
                    <div className="flex">
                        ...
                        <span className="" title="Default Sorting">
                            ...
                            >
                                <option onClick={() => updateType("default")}>
                                    Default Sorting
                                </option>
                                <option
                                    onClick={() => updateType("the-cheapest")}
                                >
                                    The Cheapest
                                </option>
                                <option
                                    onClick={() => updateType("most-expensive")}
                                >
                                    Most Expensive
                                </option>
                            </select>
                ...
                <div className=" grid grid-cols-3 gap-4  my-[30px]">
                    {data?.data?.map(
                        (
                            { title, price, discount_price, main_image, _id },
                            index
                        ) => {
                            return (
                                <div key={index}>
